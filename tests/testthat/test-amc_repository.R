...
test_that("Datasource repository path is child path of amc repository", {
  ...
  test_repository_path <- prepare_local_test_repository(test_name)
  expected_datasource_path <- file.path(test_repository_path, test_datasource_code)
...
test_that("Dataset repository path is child path of datasource repository", {
  ...
  test_repository_path <- prepare_local_test_repository(test_name)
  expected_dataset_path <- file.path(test_repository_path, test_datasource_code, test_dataset1_code)
...
test_that("Dataset path is child path of dataset repository", {
  ...
  test_repository_path <- prepare_local_test_repository(test_name)
  expected_dataset_path <- file.path(test_repository_path, test_datasource_code, test_dataset1_code, test_filename)
